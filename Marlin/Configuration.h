...
#define CUSTOM_MACHINE_NAME "BC-SKR-E3"
...
#define DEFAULT_EJERK    15.0  // was 5.0 May be used by Linear Advance
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 10), (Y_MIN_POS + 10), 20 }    //front left of bed
